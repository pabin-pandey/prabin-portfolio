...
const DEFAULT_CONTENT = {
  ...
  contact: { email: "prabin.pandey@temple.edu", phone: "835-207-9312", location: "Philadelphia, PA", linkedin: "https://linkedin.com/in/prabinpandey", github: "https://github.com/prabinpandey", msg: "I'd love to hear from you. Whether you have a question, opportunity, or just want to connect — drop me a message." },
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${navBg}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <button onClick={() => nav("home")} className="group flex items-center gap-0 text-[15px] font-bold tracking-tight">
            ...
            <span className={`font-light transition-colors duration-200 ${dark ? "text-gray-700 group-hover:text-gray-500" : "text-gray-300 group-hover:text-gray-500"}`}>.dev</span>
          </button>
