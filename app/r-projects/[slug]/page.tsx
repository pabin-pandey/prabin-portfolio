  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-950">
        ...
        <BackButton fallback="/r-projects" className="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-sm font-medium transition-colors">
          ← Back to R Projects
        </BackButton>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <header className="sticky top-0 z-30 border-b border-gray-800 bg-gray-950/90 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <BackButton fallback="/r-projects" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-800">
            {Icon.back} R Projects
          </BackButton>
